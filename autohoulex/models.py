...
class Orders(models.Model):
    ...
    make = models.CharField(max_length=255, help_text="Select the car make (company)")
    model = models.CharField(max_length=255, help_text="Select the car model")
    year = models.CharField(max_length=255, help_text="Select the car year")
